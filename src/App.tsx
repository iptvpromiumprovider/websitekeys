...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#090a0d] text-slate-100 font-sans antialiased selection:bg-[#F5A623] selection:text-black">
      ...
      <main>
        {selectedProduct ? (
          /* Dedicated Buy Page with professional layout and direct checkout */
          <ProductBuyPage
          ...
          <>
            ...
            {/* 5. Frequently Asked Questions (Exact 10 questions from screenshot) */}
            <FaqSection
              faqs={FAQS}
      ...
      {/* 6. Store Footer (Exact 4 columns from screenshot) */}
      <Footer
        onSelectCategory={() => {
          setSelectedProduct(null);
